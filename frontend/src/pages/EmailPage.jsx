...
const emailData = [
    ...
    },
    {
      ...
      "reply": "This message is a **potential phishing attempt**. Legitimate Google Cloud verification requests will not be sent via SMS or email with a random verification code like 8017-9129-8261. Google will never ask you to verify your account using such a method.nn**Do not click any links or respond to this message.**nnIf you are concerned about the security of your Google Cloud account, you should:nn* **Log in directly to the Google Cloud Console** using your usual method (do not use links provided in suspicious messages).n* **Check your Google Cloud account's security settings** within the console.n* **Report the message** as spam or phishing.nnIf you believe you may have already provided sensitive information, change your Google Cloud password immediately and contact Google Cloud support directly through their official channels. Do not use contact information found in suspicious messages.",
